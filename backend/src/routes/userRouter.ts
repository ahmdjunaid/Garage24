...
router.route('/vehicle/:vehicleId')
    .delete(verifyJWT, authorizeRoles("user"), vehicleController.deleteVehicleById)
    .patch(verifyJWT, authorizeRoles("user"), uploadVehicleImage, vehicleController.updateVehicleData)
