...
const DarkModal: React.FC<ModalProps> = ({ isOpen, onClose, children, handleError }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative bg-black p-6 rounded-lg shadow-lg z-50 w-120">
        <button
        ...
        <img src={whiteLogo} alt="GARAGE24" className="w-25" />
        {children}
      </div>
    </div>
  );
