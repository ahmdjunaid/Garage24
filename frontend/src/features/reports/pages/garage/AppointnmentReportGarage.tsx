...
import { downloadAppointmentReportExcel, downloadAppointmentReportPDF, getAppointmentReport } from "../../services/reportServices";
import type { AppointmentReport, ReportSummary } from "../../types/reportTypes";

const AppointnmentReportGarage = () => {
  ...
  const response = await downloadAppointmentReportPDF(startDate, endDate);
...
const handleDownloadExcel = async () => {
  const response = await downloadAppointmentReportExcel(startDate, endDate);
...
export default AppointnmentReportGarage;
