...
import { fetchAppointmentsByVehicleNumApi } from "../../services/historyServices";
  ...
  const fetchAppointments = useCallback(
    async (page: number, licensePlate: string) => {
      try {
        setLoading(true);
        setNoResults(false);
        const response = await fetchAppointmentsByVehicleNumApi(page, appointmentPerPage, licensePlate);
